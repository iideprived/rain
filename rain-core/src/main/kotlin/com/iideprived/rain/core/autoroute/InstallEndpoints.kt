...
private fun getRouteFunction(classInstance: Any, methodInfo: MethodInfo) : (suspend PipelineContext<Unit, ApplicationCall>.(Unit) -> Unit ) = {
    ...
    val response = try {
        ...
        if (resultTyped is com.iideprived.rain.core.model.response.BaseResponse){
        ...
        when {
            e is ErrorCodeException && e is StatusCodeException -> com.iideprived.rain.core.model.response.BaseResponse.failure<GenericResponse>(e, e.errorCode, e.statusCode)
            e is ErrorCodeException -> com.iideprived.rain.core.model.response.BaseResponse.failure<GenericResponse>(e, e.errorCode)
            e is StatusCodeException -> com.iideprived.rain.core.model.response.BaseResponse.failure<GenericResponse>(e, statusCode = e.statusCode)
            else -> com.iideprived.rain.core.model.response.BaseResponse.failure<GenericResponse>(e)
        }.apply { statusCode = this.statusCode }
    } catch (e: Exception){
        // TODO: Add logging
        com.iideprived.rain.core.model.response.BaseResponse.failure<GenericResponse>(e).apply { statusCode = this.statusCode }
    }
